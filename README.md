...
*Campaigns: matching campaigns get outlined **purple** on the page itself, and each one says what it still costs you right there — **⏱ in grey when there is no hurry** (*Marvel Rivals: 2h 55m*), and **⏳ in red** instead when it is about to close. The panel lists the same campaigns with their rewards, the hours each one needs, the filter chips and the sort, and **the ones you already own are ticked and struck through** so what stands out is what is left. / Campañas: las campañas que coinciden se enmarcan en **morado** en la propia página, y cada una dice ahí mismo lo que todavía te cuesta — **⏱ en gris cuando no corre prisa** (*Marvel Rivals: 2h 55m*), y **⏳ en rojo** en su lugar cuando está por cerrar. El panel lista esas mismas campañas con sus recompensas, las horas que pide cada una, las etiquetas de filtro y el orden, y **las que ya tienes van con ✓ y tachadas**, para que lo que resalte sea lo que falta.*
